...
clean_hansard_entities <- function(decade_of_interest){
  ...
  decade_of_interest$entity <- gsub("crimean war war department", "crimean war", decade_of_interest$entity)
  
  
  #crimean war lord rokeby
  #crimean war enormous quantities of stores
  #crimean war black sea
  #crimean war great advantage
  #crimean war department
  #crimean war noncommissioned officers
  #crimean war no despatch
